...
&lt;iframe src="'.get_home_url().'/?p='.get_the_ID().'" title="'.$iframe_title.'" style="border:0px #ffffff none;" name="Richcontent" scrolling="no" frameborder="0" marginheight="0px" marginwidth="0px" height="600px" width="800px" onload="resizeIframe(this)" allowfullscreen&gt;&lt;/iframe&gt;
                  </div>
