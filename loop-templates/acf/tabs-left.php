...
<div class="nav flex-column col-4" id="v-pills-tab" role="tablist" aria-orientation="vertical">
  ...
  <a class="h4 nav-link text-right h5 " id="v-pills-home-tab" data-toggle="pill" href="#<?php echo str_replace(' ', '', get_sub_field('field_5a14fdfcc7bba')); ?>" role="tab" aria-controls="v-pills-home" aria-selected="true"><?php echo the_sub_field('field_5a14fdfcc7bba');?></a>
