...
<div class="nav flex-column col-4" id="v-pills-tab" role="tablist" aria-orientation="vertical">
  ...
  <a class=" nav-link text-right  " aria-hidden="true" id="v-pills-home-tab" data-toggle="pill" href="#<?php echo str_replace(str_split('\\()/:*?"<>,.| '), '', get_sub_field('field_5a14fdfcc7bba')); ?>" role="tab" aria-controls="v-pills-home" aria-selected="true"><h3 class="h5"><?php echo the_sub_field('field_5a14fdfcc7bba');?></h3></a>
<?php endwhile;?>
</div>
<div class="tab-content border-0 col-8 pt-1" id="v-pills-tabContent">
  <?php while (have_rows('field_5a13c7fda9110')) : the_row();?>

<h3 class="h5 sr-only"><?php echo the_sub_field('field_5a14fdfcc7bba');?></h3>
