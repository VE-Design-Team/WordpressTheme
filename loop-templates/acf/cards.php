...
<div class="card <?php if ($x=1) echo "ml-0";?> <?php if ($x!==$numrows) echo "mr-0";?>">
  ...
  if (get_sub_field('field_5a1b730bb4a87') != "custom"): ?>
   <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/<?php echo $card_image ?>.png" alt="<?php echo $card_title; ?>" class="float-left" width="60"  />
...
<?php echo $card_title; ?>
   ...
   <?php else:{}; ?>
    ...
    <div class="card-body">
      <hr>   <?php echo $card_content ?>
    </div> 
  </div>
  
  <div class="pixel"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
