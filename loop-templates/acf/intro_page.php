...
<div id="tabs">
  ...
  <?php while (have_rows('field_5a67bc57f0b60')) : the_row();?>
    ...
    <li class="nav-item"><a class="nav-link" id="<?php echo str_replace(' ', '', get_sub_field('field_5a67bc81f0b61')); ?>-tab" data-toggle="tab" href="#<?php echo str_replace(str_split('\\/:*?"<>,.| '), '', get_sub_field('field_5a67bc81f0b61')); ?>" role="tab" aria-controls="<?php echo str_replace(' ', '', get_sub_field('field_5a67bc81f0b61')); ?>" aria-selected="true"> 
        <div class="title"><?php echo the_sub_field('field_5a67bc81f0b61');?>  <i class="fa fa-chevron-down fa-sm"></i></div></a></li>
...
//}
?>
    <div class="tab-pane fade show" id="<?php echo str_replace(str_split('\\/:*?"<>,.| '), '', get_sub_field('field_5a67bc81f0b61')); ?>" role="tabpanel" aria-labelledby="<?php echo str_replace(str_split('\\/:*?"<>,.| '), '', get_sub_field('field_5a67bc81f0b61')); ?>-tab">
