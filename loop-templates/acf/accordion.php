...
if (have_rows('field_5a13c61e91a66')):
  ...
  // loop through the  data
    while (have_rows('field_5a13c61e91a66')) : the_row();?>
        ...
        <div id="collapse<?php echo str_replace(str_split('\\/:*?"<>,.| '), '', get_sub_field('field_5a13c67d91a67')); ?>" class="collapse mt-3 pl-3" role="tabpanel" aria-labelledby="heading<?php echo str_replace(' ', '', get_sub_field('field_5a13c67d91a67')); ?>">
