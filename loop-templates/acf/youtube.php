...
</style><div class="hytPlayerWrapOuter text-center">
<div class="hytPlayerWrap">
<?php echo "<iframe width='640' height='360' src='https://www.youtube.com/embed/"; ?>
...
<?php echo "?rel=0&enablejsapi=1' frameborder='0' ></iframe>"; ?>
 ...
 if( $file ): ?>
     <div class="text-center mx-0">
       <a class="btn border-0 rounded-0 ripple-card text-center mx-0 mt-3" href="<?php echo $file['url']; ?>"><?php echo "Download Transcript"; ?></a>
     </div>
 <?php endif; ?>
