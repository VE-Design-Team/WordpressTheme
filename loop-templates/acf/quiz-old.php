...
?>
            <div class=" d-flex justify-content-center ">
              ...
              <div class="col"><a class="carousel-control-prev" href="#questions" data-slide="prev" title=" Previous question"> </a></div>
...
?>
              ...
              <div class="col"> <a class="carousel-control-next" href="#questions" data-slide="next" title="Next question"></a></div>
            </div>
            </div>
          </div>
        </div>
