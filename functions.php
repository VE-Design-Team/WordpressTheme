  ...
  if ( ! function_exists('custom_post_type') ) {
    ...
    function custom_post_type() {
        ...
        $labels = array(
            ...
            'singular_name'         => _x( 'scorm', 'Post Type Singular Name', 'text_domain' ),
            'menu_name'             => __( 'SCORM', 'text_domain' ),
            'name_admin_bar'        => __( 'SCORM', 'text_domain' ),
        ...
        $args = array(
            'label'                 => __( 'scorm', 'text_domain' ),
            'description'           => __( 'SCORM page creator', 'text_domain' ),
            'labels'                => $labels,
